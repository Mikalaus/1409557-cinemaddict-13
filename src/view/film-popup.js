import {createFilmPopupComment} from './film-popup--comment.js';
import {createFilmPopupGenres} from './film-popup-genres.js';
...
export const createFilmPopupTemplate = (obj) => {
  ...
  const {
    ...
    commentsAmount,
    comments,
    popup: {originalTitle, producer, screenwriter, stars, country, fullDescription, ageLimit, date}} = obj;
